                ...
                children: [
                  CustomTextFormField(
                    ...
                    controller: TextEditingController(
                      text: context.watch<AjoutCatGorieProvider>().selectedImageName,
                    ), // Update to show selected image name
                    suffix: IconButton(
                      ...
                      onPressed: () async {
                        ...
                        if (result != null) {
                          ...
                          context.read<AjoutCatGorieProvider>().setSelectedImageName(
                            result.names.first ?? '', // Get the first selected image name
                          );
                        }
                      },
                    ),
